...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.marshrutesRoutesTwo.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.marshrutes-routes-twos.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('marshrutesroutes_floor') ? 'is-invalid' : '' }}" name="marshrutesroutes_floor_id" id="marshrutesroutes_floor_id" onchange="$('#imageToSwap').attr('src', this.options[this.selectedIndex].title);" required>
                    @foreach($marshrutesroutes_floors2 as $id => $marshrutesroutes_floor)
                        <option title="{{ $marshrutesroutes_floor->marshrutesfloor_image->getUrl() }}" value="{{ $marshrutesroutes_floor->id }}" {{ old('marshrutesroutes_floor_id') == $id ? 'selected' : '' }}>{{ $marshrutesroutes_floor->marshrutesfloor_title }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('marshrutesroutes_floorsecond') ? 'is-invalid' : '' }}" name="marshrutesroutes_floorsecond_id" id="marshrutesroutes_floorsecond_id" onchange="$('#imageToSwap2').attr('src', this.options[this.selectedIndex].title);">
                    ...
                    <option title="{{ $marshrutesroutes_floorsecond->marshrutesfloor_image->getUrl() }}" value="{{ $marshrutesroutes_floorsecond->id }}" {{ old('marshrutesroutes_floorsecond_id') == $id ? 'selected' : '' }}>{{ $marshrutesroutes_floorsecond->marshrutesfloor_title }}</option>
                    @endforeach
                </select>
