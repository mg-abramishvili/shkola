...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.marshrutesFloor.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.marshrutes-floors.update", [$marshrutesFloor->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                <label class="required" for="marshrutesfloor_title">{{ trans('cruds.marshrutesFloor.fields.marshrutesfloor_title') }}</label>
                <input class="form-control {{ $errors->has('marshrutesfloor_title') ? 'is-invalid' : '' }}" type="text" name="marshrutesfloor_title" id="marshrutesfloor_title" value="{{ old('marshrutesfloor_title', $marshrutesFloor->marshrutesfloor_title) }}" required>
