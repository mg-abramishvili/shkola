...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.photoalbum.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.photoalbums.update", [$photoalbum->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('phs_title') ? 'is-invalid' : '' }}" type="text" name="phs_title" id="phs_title" value="{{ old('phs_title', $photoalbum->phs_title) }}" required>
