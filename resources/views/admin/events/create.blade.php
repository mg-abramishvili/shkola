    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.events.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ev_title') ? 'is-invalid' : '' }}" type="text" name="ev_title" id="ev_title" value="{{ old('ev_title', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('ev_date') ? 'is-invalid' : '' }}" type="text" name="ev_date" id="ev_date" value="{{ old('ev_date') }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('ev_text') ? 'is-invalid' : '' }}" name="ev_text" id="ev_text">{!! old('ev_text') !!}</textarea>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('ev_cat') ? 'is-invalid' : '' }}" name="ev_cat" id="ev_cat" required>
                    ...
                    @foreach(App\Event::EV_CAT_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('ev_cat', '') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
