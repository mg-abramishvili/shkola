    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.teachers.update", [$teacher->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('tch_name') ? 'is-invalid' : '' }}" type="text" name="tch_name" id="tch_name" value="{{ old('tch_name', $teacher->tch_name) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('tch_spec') ? 'is-invalid' : '' }}" type="text" name="tch_spec" id="tch_spec" value="{{ old('tch_spec', $teacher->tch_spec) }}" required>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('tch_text') ? 'is-invalid' : '' }}" name="tch_text" id="tch_text">{!! old('tch_text', $teacher->tch_text) !!}</textarea>
            ...
            <!--<div class="form-group">
                ...
                <select class="form-control {{ $errors->has('tch_category') ? 'is-invalid' : '' }}" name="tch_category" id="tch_category">
                    ...
                    @foreach(App\Teacher::TCH_CATEGORY_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('tch_category', $teacher->tch_category) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
