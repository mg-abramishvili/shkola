    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.news.update", [$news->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nw_title') ? 'is-invalid' : '' }}" type="text" name="nw_title" id="nw_title" value="{{ old('nw_title', $news->nw_title) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('nw_date') ? 'is-invalid' : '' }}" type="text" name="nw_date" id="nw_date" value="{{ old('nw_date', $news->nw_date) }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('nw_text') ? 'is-invalid' : '' }}" name="nw_text" id="nw_text">{!! old('nw_text', $news->nw_text) !!}</textarea>
            ...
            <!--<div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('nw_phs') ? 'is-invalid' : '' }}" name="nw_phs_id" id="nw_phs_id">
                    @foreach($nw_phs as $id => $nw_phs)
                        <option value="{{ $id }}" {{ ($news->nw_phs ? $news->nw_phs->id : old('nw_phs_id')) == $id ? 'selected' : '' }}>{{ $nw_phs }}</option>
                    @endforeach
                </select>
